      ...
      <ul class="navbar-nav mr-auto">
        <?php
          if($activePage === "GALLERY"){
            ...
            echo "<li class='nav-item'><a class='nav-link' href='index.php'>Home</a></li><li class='nav-item'><a class='nav-link' href='gallery.php'>Gallery</a></li><li class='nav-item'><a class='nav-link' href='cinema.php'>Cinema</a></li><li class='nav-item'><a class='nav-link' href='upload.php'>Upload File</a></li><li class='nav-item active'><a class='nav-link' href='login.php'>Log In</a></li><li class='nav-item'><a class='nav-link' href='register.php'>Register</a></li>";
          } else if($activePage === "REGISTER") {
            echo "<li class='nav-item'><a class='nav-link' href='index.php'>Home</a></li><li class='nav-item'><a class='nav-link' href='gallery.php'>Gallery</a></li><li class='nav-item'><a class='nav-link' href='cinema.php'>Cinema</a></li><li class='nav-item'><a class='nav-link' href='upload.php'>Upload File</a></li><li class='nav-item'><a class='nav-link' href='login.php'>Log In</a></li><li class='nav-item active'><a class='nav-link' href='register.php'>Register</a></li>";
            ...
            echo "<li class='nav-item active'><a class='nav-link' href='index.php'>Home</a></li><li class='nav-item'><a class='nav-link' href='gallery.php'>Gallery</a></li><li class='nav-item'><a class='nav-link' href='cinema.php'>Cinema</a></li><li class='nav-item'><a class='nav-link' href='upload.php'>Upload File</a></li><li class='nav-item'><a class='nav-link' href='api/logOut.php'>Log Out</a></li>";
              ...
              echo "<li class='nav-item active'><a class='nav-link' href='index.php'>Home</a></li><li class='nav-item'><a class='nav-link' href='gallery.php'>Gallery</a></li><li class='nav-item'><a class='nav-link' href='cinema.php'>Cinema</a></li><li class='nav-item'><a class='nav-link' href='upload.php'>Upload File</a></li><li class='nav-item'><a class='nav-link' href='login.php'>Log In</a></li><li><li class='nav-item'><a class='nav-link' href='register.php'>Register</a></li>";
          }
